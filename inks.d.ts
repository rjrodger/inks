...
declare function walk(key: string, val: any, modify_property: ModifyProperty, options: Options): any;
declare function make_modify_property(ctxt: any, options: Options): (key: string, val: string) => any;
