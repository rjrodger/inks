...
let walkers:any = {
  ...
  'number': (tm: number, modify_property: any) => { return tm },
  'bigint': (tm: bigint, modify_property: any) => { return tm },
  'boolean': (tm: boolean, modify_property: any) => { return tm },
  'symbol': (tm: symbol, modify_property: any) => { return tm },
  'function': (tm: any, modify_property: any) => { return tm },
  'any': (tm: any, modify_property: any) => { return tm },
}
